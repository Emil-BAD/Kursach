...
from db.models import EventRegistration, Event, User
from schemas.event import EventRegistrationCreate, EventRegistrationResponse, PaginatedEventRegistrationResponse, EventRegistrationUpdate
